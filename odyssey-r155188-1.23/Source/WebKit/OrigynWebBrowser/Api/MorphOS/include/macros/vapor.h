 ...
 *
 *
 * 2010 - amigaos4 adaptation by Deniil and kas1e
 *
 *
 * $Id: vapor.h,v 1.10 2006/08/16 14:24:35 geit Exp $
 *
*/
...
#define DOSUPER DoSuperMethodA(cl,(Object *)obj,(Msg)msg)
 ...
 * Some common methods
 */
#define DECNEW case OM_NEW:return(handleOM_NEW(cl, (Object*) obj, (struct opSet *)msg));
#define DECCONST DECNEW // obsolete
#define DECDISPOSE case OM_DISPOSE:return(handleOM_DISPOSE(cl, (Object *)obj, (struct opSet *)msg));
#define DECDISP DECDISPOSE // obsolete
#define DECSET case OM_SET:return(handleOM_SET(cl, (Object *)obj, (struct opSet *)msg));
#define DECGET case OM_GET:return(handleOM_GET(cl, (Object *)obj, (struct opGet *)msg));
#ifdef __amigaos4__
#define DECADDMEMBER case OM_ADDMEMBER:return(handleOM_ADDMEMBER(cl, obj, (struct opMember *)msg));
#define DECREMMEMBER case OM_REMMEMBER:return(handleOM_REMMEMBER(cl, obj, (struct opMember *)msg));
#else
#define DECADDMEMBER case OM_ADDMEMBER:return(handleOM_ADDMEMBER(cl, (Object *)obj, (APTR)msg));
#define DECREMMEMBER case OM_REMMEMBER:return(handleOM_REMMEMBER(cl, (Object *)obj, (APTR)msg));
#endif
#define DECMMETHOD(methodid) case MUIM_##methodid:return(handleMUIM_##methodid(cl, (Object *)obj,(struct MUIP_##methodid *)msg));
#define DECMETHOD(methodid) case MM_##methodid:return(handleMM_##methodid(cl, (Object *)obj,(type) msg));
#define DECSMETHOD(methodid) case MM_##methodid:return(handleMM_##methodid(cl, (Object *)obj,(struct MP_##methodid *)msg));
#define DECTMETHOD(methodid) case MM_##methodid:return(handleMM_##methodid(cl, (Object *)obj,(Msg) msg));
	...
	{ \
		if (!(mcc##name = (struct MUI_CustomClass *)MUI_CreateCustomClass(NULL, super, NULL, sizeof(struct Data), (APTR)DISPATCHERREF))) \
			...
			if (MUIMasterBase->lib_Version >= 20) \
				mcc##name->mcc_Class->cl_ID = (const char *) #name; \
		return (TRUE); \
	} \
...
#define MUI_HOOK(n, y, z) \
	...
	static LONG n##_GATE2(struct Hook *h, y, z)
#else
#define DEFHOOK(n) static struct Hook n##_hook={{ 0, 0}, (HOOKFUNC)n##_func, NULL, 0}
