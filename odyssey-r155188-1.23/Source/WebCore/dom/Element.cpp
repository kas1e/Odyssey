...
void Element::finishParsingChildren()
{
	...
	#ifdef __amigaos4__
	checkForSiblingStyleChanges(this, FinishedParsingChildren, ElementTraversal::lastChild(this), NULL);
	#else
...
void Element::clearBeforePseudoElement()
{
	...
	#ifdef __amigaos4__
	elementRareData()->setBeforePseudoElement(NULL);
	#else
...
void Element::clearAfterPseudoElement()
{
	...
	#ifdef __amigaos4__
	elementRareData()->setAfterPseudoElement(NULL);
	#else
