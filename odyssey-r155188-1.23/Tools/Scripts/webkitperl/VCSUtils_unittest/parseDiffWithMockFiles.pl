...
},
{
    ...
    inputText => <<"EOF",
Index: Tools/MakefileWithWindowsEOL
===================================================================
--- Tools/MakefileWithWindowsEOL	(revision 53052)
+++ Tools/MakefileWithWindowsEOL	(working copy)
@@ -1,3 +1,4 @@\r
...
},
{
    ...
    inputText => <<"EOF",
Index: Tools/MakefileWithMacEOL
===================================================================
--- Tools/MakefileWithMacEOL	(revision 53052)
+++ Tools/MakefileWithMacEOL	(working copy)
...
[{
    # Same as input text
    svnConvertedText => q(Index: Tools/MakefileWithMacEOL
===================================================================
--- Tools/MakefileWithMacEOL	(revision 53052)
+++ Tools/MakefileWithMacEOL	(working copy)
@@ -1,3 +1,4 @@\r MODULES = JavaScriptCore JavaScriptGlue WebCore WebKit WebKitTools\r \r-all:
...
--- Tools/a/MakefileWithWindowsEOL
+++ Tools/b/MakefileWithWindowsEOL
@@ -1,3 +1,4 @@\r
 MODULES = JavaScriptCore JavaScriptGlue WebCore WebKit WebKitTools\r
 \r
-all:
...
index e7e8475..ae16fc3 100644
--- Tools/a/MakefileWithMacEOL
+++ Tools/b/MakefileWithMacEOL
@@ -1,3 +1,4 @@\r MODULES = JavaScriptCore JavaScriptGlue WebCore WebKit WebKitTools\r \r-all:
\\ No newline at end of file
+all:\r+\r
EOF
