...
IF(WIN32)
    ## We had some directories for find SDLgfx.lib & headers under windows
    FIND_PATH(SDLGFX_INCLUDE_DIR SDL_gfxPrimitives.h ${WINLIB_INC_PATH} ${WINLIB_INC_PATH}/SDL ${WINLIB_INC_PATH}/SDLgfx)
ENDIF(WIN32)
...
IF(WIN32)
    ## We had some directories for find SDLgfx.lib & headers under windows        
    FIND_FILE(SDLGFX_LIBRARY SDL.lib ${WINLIB_LIB_PATH} ${WINLIB_LIB_PATH}/SDLgfx ${WINLIB_LIB_PATH}/SDL)
ENDIF(WIN32)
