...
gboolean MediaPlayerPrivateGStreamer::handleMessage(GstMessage* message)
{
    ...
    GOwnPtr<gchar> debug;
#else
    GError* err = (GError*) fastMalloc(sizeof(GError));
    gchar* debug = (gchar*) fastMalloc(sizeof(debug));
#endif
...
void MediaPlayerPrivateGStreamer::setAspect(MediaPlayer::VideoScale scale)
{
    ...
    case MediaPlayer::ArbitraryScale:
        break;
    case MediaPlayer::Quatersize:
        break;
    case MediaPlayer::NoScale:
        break;
    case MediaPlayer::Fullscreen:
        break;
    }
    sizeChanged();
}
